...
export default function LoginBox() {
  ...
  async function loginWithDiscord() {
    console.log("Discord");
    setIsLoading((prev) => (prev = { ...prev, discord: !prev.discord }));
    try {
  ...
  return (
    <div className="flex  w-full items-center justify-center">
      <Card className="m-0 max-w-xl  flex-1 border-0 p-0 ">
        {/* <CardHeader>
        ...
        <CardContent className="p-0 pb-0">
          <FormProvider {...form}>
            <form className="space-y-8">
              {/* <div className="flex flex-1 flex-col space-y-6 sm:flex-row sm:space-x-4 sm:space-y-0"> */}
              <FormField
              ...
              <Button
                ...
                size="lg"
                className="w-full"
                onClick={(event) => void form.handleSubmit(onSubmit)(event)}
                disabled={isLoading.credential}
              >
                {isLoading.credential ? null : (
                  <CornerDownLeft className="mr-2 h-[0.8rem] w-[0.8rem]" />
                )}
